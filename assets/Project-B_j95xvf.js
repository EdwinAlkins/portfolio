import{n as e}from"./rolldown-runtime-Bh1tDfsg.js";import{i as t,n}from"./analytics-CpScIfsJ.js";import{r,s as i,t as a}from"./react-vendor-kOwVo2tE.js";import{c as o,i as s,n as c,o as l,s as u,u as d}from"./index-MPH1TvpD.js";import f from"./NotFound-a43tYydx.js";var p=e(t()),m=a(),h={github:{icon:`fab fa-github`,label:`GitHub`},demo:{icon:`fas fa-external-link-alt`,label:`Live Demo`},documentation:{icon:`fas fa-book`,label:`Documentation`},pypi:{label:`PyPI`},article:{label:`Article`}},g=e=>e.charAt(0).toUpperCase()+e.slice(1),_=d.div`
  color: ${o};
`,v=d.div`
  max-width: 1000px;
  margin: 0 auto;
